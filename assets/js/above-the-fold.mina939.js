!(function(a, b, c) {
        ...
        for (e = d(b.fn, "function") ? b.fn() : b.fn, f = 0; f < a.length; f++)
          (g = a[f]),
            ...
            1 === h.length
              ? (w[h[0]] = e)
              : (!w[h[0]] ||
                  w[h[0]] instanceof Boolean ||
                  (w[h[0]] = new Boolean(w[h[0]])),
                (w[h[0]][h[1]] = e)),
            t.push((e ? "" : "no-") + h.join("-"));
      }
  }
  ...
  function j() {
    var a = b.body;
    return a || ((a = i(z ? "svg" : "body")), (a.fake = !0)), a;
  }
  function k(a, c, d, e) {
    var f,
      g,
    ...
    if (parseInt(d, 10))
      for (; d--; )
        (h = i("div")), (h.id = e ? e[d] : l + (d + 1)), m.appendChild(h);
    return (
      (f = i("style")),
      (f.type = "text/css"),
      (f.id = "s" + l),
      ...
      (g = c(m, a)),
      n.fake
        ? (n.parentNode.removeChild(n), (y.style.overflow = k), y.offsetHeight)
  ...
  function n(a, b, c) {
    ...
    for (var f in a)
      if (a[f] in b)
        return c === !1
          ? a[f]
          : ((e = b[a[f]]), d(e, "function") ? m(e, c || b) : e);
    return !1;
  }
  function o(b, c, d) {
    var e;
  ...
  function p(b, d) {
    ...
    if ("CSS" in a && "supports" in a.CSS) {
      for (; e--; ) if (a.CSS.supports(h(b[e]), d)) return !0;
      return !1;
    }
    if ("CSSSupportsRule" in a) {
      for (var f = []; e--; ) f.push("(" + h(b[e]) + ":" + d + ")");
      return (
        (f = f.join(" or ")),
        k(
  ...
  function q(a, b, e, f) {
    ...
    for (
      var k, m, n, o, q, r = ["modernizr", "tspan", "samp"];
      !K.style && r.length;

    )
      (k = !0), (K.modElem = i(r.shift())), (K.style = K.modElem.style);
    for (n = a.length, m = 0; n > m; m++)
      if (
        ...
        if (f || d(e, "undefined")) return h(), "pfx" != b || o;
        try {
          K.style[o] = e;
        } catch (a) {}
        if (K.style[o] != q) return h(), "pfx" != b || o;
      }
    return h(), !1;
  }
  ...
  var y = b.documentElement,
    ...
    A = (function() {
      function a(a, b) {
        ...
        return (
          !!a &&
          ((b && "string" != typeof b) || (b = i(b || "div")),
          (a = "on" + a),
          (e = a in b),
          !e &&
            d &&
            (b.setAttribute || (b = i("div")),
            b.setAttribute(a, ""),
  ...
  var L = (v.prefixed = function(a, b, c) {
    return 0 === a.indexOf("@")
      ? H(a)
      : (-1 != a.indexOf("-") && (a = g(a)), b ? r(a, b, c) : r(a, "pfx"));
  });
  (v.prefixedCSS = function(a) {
    ...
    w.addTest("cssfilters", function() {
      if (w.supports) return s("filter", "blur(2px)");
      var a = i("a");
      return (
        (a.style.cssText = x.join("filter:blur(2px); ")),
...
(dtGlobals.isMobile = /(Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|windows phone)/.test(
  ...
  jQuery(document).ready(function(a) {
    ...
    e.indexOf("phone") != -1 && dtGlobals.isMobile
      ? (dtGlobals.isPhone = !0)
      : e.indexOf("tablet") != -1 && dtGlobals.isMobile
      ? (dtGlobals.isTablet = !0)
      : (dtGlobals.isDesktop = !0);
    var f;
    !dtGlobals.isMobile || dtGlobals.isWindowsPhone || dtGlobals.isAndroid
      ...
      b
        .on("debouncedresize", function(b) {
          a(".mini-widgets, .mobile-mini-widgets")
            .find(" > *")
