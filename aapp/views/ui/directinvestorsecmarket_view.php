...
<head>
    ...
    <title> Naija Art Mart | <?php echo $usertype; ?> Secondary Market</title>
                ...
                <div class="explore-artwork-inr">
                    ...
                    <div class="col-lg-8 col-heading-otr">
                        <div class="heading-inr">
                            <h3 class=""><?php echo $usertype; ?> Secondary Market</h3>
                    ...
                    <div class="row row-custom-main">
                        <div id="tab-1" class="tab-content active">
                            <div class="row row-custom-inr">
                              ...
                              <?php 
                if (count($DirectMarketData) > 0)
                {
                  foreach($DirectMarketData as $row) {
                    $url='&nbsp;';
                    if ($row['blockchainUrl']) {
                                ...
                                <div class="col-md-3">
                                  <div class="wsk-cp-product">
                                    <div class="wsk-cp-img">
                                          <a href="<?php echo site_url('ui/ArtworkDetails/Market/').$row['symbol'] ?>?action=buy" class="tilt-otr img-tilt" data-tilt="">
                                    ...
                                    <div class="wsk-cp-text">
                                      ...
                                      <div class="card-footer">
                                        ...
                                        <div class="wcf-left">Price : <span class="price"><?php echo '₦'.number_format($row['close_price'],2) ?></span></div>
                                        <div class="wcf-right"><a href="<?php echo site_url('ui/ArtworkDetails/Market/').$row['symbol'] ?>?action=buy" class="btn btn-sm btn-primary">Buy</a></div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <p style="text-align:center;" class="justify-content-center">No Available Data</p>
                        </div>
                      </div>
...
<script>
    ...
    if (<?php echo count($DirectMarketData); ?> <= 0) {
        $.ajax({
            url: "https://www.naijaartmart.com/ethoz/admin/ArtxCore/SetDayPrice",
            type: "POST",
            data: {},
    ...
    */
    ...
    function LocateMessage(msgid,header,details,msgdate,category) {
