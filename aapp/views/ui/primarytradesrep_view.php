		...
		$(document).ready(function(e) {
			...
			$('#btnPDF').click(function(e) 
			{
				try
				{
					...
					if (sdt==edt)
					{
						reportfile="primarytradereport_"+sd+".pdf";
					}else
					{
						reportfile="primarytradereport_from_"+sd+'_to_'+ed+".pdf";
					}
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep/CreatePDFReport'); ?>",
						data: mydata,
						type: 'POST',
						dataType: 'text',
			...
			function DisplayReport(em,sym,sdt,edt)
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep/DisplayReport');?>",
						data: mydata,
						type: 'POST',
						dataType: 'json',
			...
			function LoadSymbols()
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep/GetSymbols');?>",
						type: 'POST',
						dataType: 'json',
						success: function(data,status,xhr) {	
							$.unblockUI();
                  ...
                  <div class="tab-content">                                    
                    ...
                    <div id="data" class="tab-pane fade in active">
                      ...
                      <div title="Issuer Email" class="position-relative row form-group">
                      		<label for="lblIssuer" class="col-sm-2 col-form-label text-right">Email</label>
