...
<head>
    ...
    <title> Naija Art Mart | <?php echo $userType; ?> Primary Market</title>
                ...
                <div class="explore-artwork-inr">
                    ...
                    <div class="col-lg-8 col-heading-otr">
                        <div class="heading-inr">
                            <h3 class="heading heading-h3">Primary Market</h3>
                        </div>
                        ...
                        <div id="tab-1" class="tab-content active">
                            <div class="row row-custom-inr">
                                ...
                                <div class="col-otr col-lg-3">
                                    <div class="col-inr box3" style="padding:8px !important; background:#f2f2f2;box-shadow: 4px 4px 6px #e1dbdb; border-radius:6px;">
                                        <div class="img-otr">
                                            <a href="<?php echo site_url('ui/Directinvestorprymarket/ArtworkDetails/').$row['art_id'] ?>" class="tilt-otr img-tilt" data-tilt="">
                                                <img class="img-inr img-fluid" src="<?php echo base_url().'art-works/'.trim($row['pix']) ?>" alt="artwork-img">
                                           ...
                                           <!--  <div class="timer-otr">
                                                <div class="body-sb" ><?php echo '₦'.number_format($row['price_on_issue'],2) ?></div>
                                            </div> -->
                                        </div>
                                        <div class="row" style="font-family: 'DMSans-Regular' !important; display: inline-flex;margin: 10px !important; border-radius: 20px; padding: 4px !important; background: #f0eaea;">
                                            <div class="col-lg-6" style="text-overflow: ellipsis;">
                                                <span> Tokens<br> <?php echo number_format($row['tokens_available'],0) ?></span>
                                            </div>
                                        
                                            <div class="col-lg-6" style="text-overflow: ellipsis;">
                                                <span class="">Value<br></p>
                                                <span style="font-weight: bolder;"><?php echo '₦'.number_format($row['artwork_value'],2) ?></span>
                                            </div>
                                            <div class="col-lg-12">
                                                <h4 class="body-mb" ><center><?php echo trim($row['title']) ?></center></h4>
                                                <span class="body-sb link" style="font-family: 'cambria' sans-serif; font-weight: bold;"><center><i>By <?php echo ucwords(trim($row['artist'])) ?> </i></center></span>
                                            </div>
