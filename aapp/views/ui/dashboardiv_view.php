                        ...
                        <div class="heading-otr">
                            ...
                            <a class="view-p view-all" href="<?php echo site_url('ui/Wallet') ?>">
                                ...
                                <span class="makebold size-15" style="color: inherit;">
                                    ₦
                                    <span style="top: 0;" id="uiWalletBalance"> <?php echo number_format($balance,2) ?> </span>
                                </span>
                            </a>
                            <?php }?>
                        </div>
                        <?php if ($usertype == 'Investor') { ?>
                        <div class="popular-collection" style="padding: 20px 5px 5px 0px !important; background: #f5f5f5; border-radius: 15px;">
                            <div class="container-fluid">
                                <div class="popular-collection-inr">
                                    <div class="heading-otr">
                                        <div class="head-otr">
                                            <h3 class="text-center">Recent Listings</h3>
                                        </div>
                                    </div>
                                    <span class="line" ></span>
                                    <div class="row-custom owl-carousel owl-theme" style="margin:10px 0px 6px 0px !important" id="popular-artwork">
                                        <?php
                                        ...
                                        <div class="col-otr">
                                            <div class="col-inr">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <a href="<?php echo site_url('ui/Directinvestorprymarket/ArtworkDetails/'.$artwork->art_id) ?>" class="by-otr">
                                                        <span class="by body-s">by</span>
            ...
            <div class="container-fluid">
                <div class="copy-inr">
                    ...
                    <div class="copy-name body-s">
                        Copyright ©
                        <?php echo date('Y') ?>
                        <a href="#" target="_blank" class="name body-sb">Derived Homes.</a>
                    </div>
                            ...
                            if ($(data).length > 0) {
                                $.each($(data), function (i, e) {
                                    if (Usertype.toLowerCase() == "issuer") {
                                        ...
                                        $("#spnTotalIssuerListedSecuritiesValue")
                                            .html("₦" + number_format(e.TotalIssuerListedSecuritiesValue, "2", ".", ","))
                                            .css("font-weight", "bold");

                                        $("#spnTotalIssuerExecutedPrimaryTrades").html(number_format(e.TotalIssuerExecutedPrimaryTrades, "0", "", ",")).css("font-weight", "bold");

                                        $("#spnTotalIssuerExecutedPrimaryTradesValue")
                                            .html("₦" + number_format(e.TotalIssuerExecutedPrimaryTradesValue, "2", ".", ","))
                                            .css("font-weight", "bold");

                                        $("#spnTotalIssuerCurrentlyListedSecurities").html(number_format(e.TotalIssuerCurrentlyListedSecurities, "0", "", ",")).css("font-weight", "bold");

                                        $("#spnTotalIssuerCurrentlyListedSecuritiesValue")
                                            .html("₦" + number_format(e.TotalIssuerCurrentlyListedSecuritiesValue, "2", ".", ","))
                                            .css("font-weight", "bold");
                                        ...
                                        $("#spnTotalInvestorSecuritiesValue")
                                            .html("₦" + number_format(e.TotalInvestorSecuritiesValue, "2", ".", ","))
                                            .css("font-weight", "bold");

                                        $("#spnTotalInvestorPrimaryTrades").html(number_format(e.TotalInvestorPrimaryTrades, "0", "", ",")).css("font-weight", "bold");

                                        $("#spnTotalInvestorPrimaryTradesValue")
                                            .html("₦" + number_format(e.TotalInvestorPrimaryTradesValue, "2", ".", ","))
                                            .css("font-weight", "bold");

                                        $("#spnTotalInvestorSellOrders").html(number_format(e.TotalInvestorSellOrders, "0", "", ",")).css("font-weight", "bold");

                                        $("#spnTotalInvestorSellOrdersValue")
                                            .html("₦" + number_format(e.TotalInvestorSellOrdersValue, "2", ".", ","))
                                            .css("font-weight", "bold");

                                        $("#spnTotalInvestorExecutedSellOrders").html(number_format(e.TotalInvestorExecutedSellOrders, "0", "", ",")).css("font-weight", "bold");

                                        $("#spnTotalInvestorExecutedSellOrdersValue")
                                            .html("₦" + number_format(e.TotalInvestorExecutedSellOrdersValue, "2", ".", ","))
                                            .css("font-weight", "bold");
                                    }
