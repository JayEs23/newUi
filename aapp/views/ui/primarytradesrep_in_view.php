		...
		$(document).ready(function(e) {
			...
			$('#btnPDF').click(function(e) 
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep_in/CreatePDFReport'); ?>",
						data: mydata,
						type: 'POST',
						dataType: 'text',
			...
			function DisplayReport(em,sym,sdt,edt)
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep_in/DisplayReport');?>",
						data: mydata,
						type: 'POST',
						dataType: 'json',
			...
			function LoadSymbols()
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Primarytradesrep_in/GetSymbols');?>",
						type: 'POST',
						dataType: 'json',
						success: function(data,status,xhr) {	
							$.unblockUI();
