...
<head>
    ...
    <link rel="icon" href="<?php echo base_url(); ?>/assets/images/d_favicon.png" sizes="16x16">
                      ...
                      <div class="popular-collection" style="padding: 0 0 30px 0 !important;">
                        <div class="container-fluid">
                          <div class="popular-collection-inr">
                            <div class="heading-otr">
                                <div class="head-otr">
                                    <h3 class="heading heading-h3">Popular Art works</h3>
                                </div>
                            </div>
                            <span class="line"></span>
                                ...
                                <div class="col-otr">
                                    <div class="col-inr">
                                        ...
                                        <div class="content">
                                            ...
                                            <a href="<?php echo site_url('ui/Directinvestorprymarket/ArtworkDetails/'.$artwork->art_id) ?>" class="art-title body-sb"><?php echo $artwork->title ?></a>
                                            <a href="<?php echo site_url('ui/Directinvestorprymarket/ArtworkDetails/'.$artwork->art_id) ?>" class="by-otr body-sb"> <span class="by body-s">by</span> <?php echo $artwork->artist ?></a>
                                        </div>
                                    </div>
                                </div>
                              <?php } ?>
                              ...
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalActiveInvestors"><?php echo number_format($TotalActiveInvestors,0) ?></p>
                                      <p class="body-sb create-pb">Total Active Investors</p>
                                  </div>
                              </a>
                          </div>
                          <div class="col-lg-4 col-md-3 col-sm-4 creator-otr">
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalSecondaryTradeOrders"><?php echo '₦'.number_format($TotalSecondaryTradeOrders,2) ?></p>
                                      <p class="body-sb create-pb">Total Secondary Trade Orders</p>
                                  </div>
                              </a>
                          </div>
                          <div class="col-lg-4 col-md-3 col-sm-4 creator-otr">
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalExecutedSecondaryTrades"><?php echo number_format($TotalExecutedSecondaryTrades,0) ?></p>
                                      <p class="body-sb create-pb">Total Executed Secondary Trades</p>
                                  </div>
                              </a>
                          </div>
                          <div class="col-lg-4 col-md-3 col-sm-4 creator-otr">
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalExecutedPrimaryTrades"><?php echo number_format($TotalExecutedPrimaryTrades,0) ?></p>
                                      <p class="body-sb create-pb">Total Executed Primary Trades</p>
                                  </div>
                              </a>
                          </div>
                          <div class="col-lg-4 col-md-3 col-sm-4 creator-otr">
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalPersonalPortfolioValue"><?php echo '₦'.number_format($TotalPersonalPortfolioValue,2) ?></p>
                                      <p class="body-sb create-pb">Total Personal Portfolio Value </p>
                                  </div>
                              </a>
                          </div>
                          <div class="col-lg-4 col-md-3 col-sm-4 creator-otr">
                              <a href="#" class="create-inr box1">
                                  <div class="create-content">
                                    <div class="create-img">
                                      ...
                                      <p  class="body-s create-p" id="spnTotalInvestorPortfolioValue"><?php echo '₦'.number_format($TotalInvestorPortfolioValue,2) ?></p>
                                      <p class="body-sb create-pb">Total Investor Portfolio Value</p>
                                  </div>
                              </a>
                          </div>
                      <?php }
