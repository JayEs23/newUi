		...
		$(document).ready(function(e) {
			...
			$('#btnPDF').click(function(e) 
			{
				try
				{
					...
					if (sdt==edt)
					{
						reportfile="secondarytradebrreport_"+sd+".pdf";
					}else
					{
						reportfile="secondarytradebrreport_from_"+sd+'_to_'+ed+".pdf";
					}
					...
					$.ajax({
						url: "<?php echo site_url('ui/Secondarytradesrep_br/CreatePDFReport'); ?>",
						data: mydata,
						type: 'POST',
						dataType: 'text',
			...
			function DisplayReport(sym,sdt,edt)
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Secondarytradesrep_br/DisplayReport');?>",
						data: mydata,
						type: 'POST',
						dataType: 'json',
			...
			function LoadSymbols()
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Secondarytradesrep_br/GetSymbols');?>",
						type: 'POST',
						dataType: 'json',
						success: function(data,status,xhr) {	
							$.unblockUI();
                    	...
                    	<table class="hover table table-bordered data-table display wrap" id="recorddisplay">
                          <thead>
                            <tr>
                                ...
                                <th style="text-align:right; padding-right:7px;" width="12%">TOTAL&nbsp;AMOUNT(₦)</th>                                
