...
<body >
	...
	<section class="hero-navbar-9">
        ...
        <div class="create-main" style="padding-top: 12px !important;">
            <div class="container-fluid" style="font-family: cursive !important; ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" id="txtName" value="<?php echo $company; ?>" type="text" placeholder="Your Name or company name">
                                </div>
                                <div class="col-md-3">
                                ...
                                <!-- Form Group (birthday)-->
                                <div class="col-md-3">
                                    <label class="small mb-1" for="txtDate">Date of Birth</label>
                                    <input class="form-control" type="text" id="txtDate" placeholder="Your Date Of Birth Or Incorporation (For Company)" value="<?php if ($dob) echo date("d M Y",strtotime($dob)); else echo ''; ?>">
                                </div>
                            </div>
                            <!-- Form Row        -->
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-3">
                                    <label class="small mb-1" for="cboCountry">Nationality</label>
        ...
        $(document).ready(function(e) {
                ...
                try
                {
                    ...
                    $.ajax({
                        ...
                        success: function(data,status,xhr) {    
                            ...
                            if ($(data).length > 0)
                            {
                                $("#cboBroker").append(new Option("Select a Broker", ""));
            ...
            function CheckForm()
            {
                try
                {
                    ...
                    if ($.isNumeric(acnm))
                    {
                        m='Your account name MUST NOT be a number. Current entry '+acnm+'</b> is not valid.';                        
                        displayMessage(m, 'error',Title,'warning');
                        $('#txtAccName').focus(); return false;
                    }
                    ...
                    if (acnm.length < 3)
                    {
                        m='Please enter your correct account name. Current entry '+acnm+'</b> is too short.';                        
                        displayMessage(m, 'error',Title,'warning');
                        $('#txtAccName').focus(); return false;
                    }
                    ...
                    if (!$.isNumeric(acno))
                    {
                        m='Your account number MUST be a number. Current entry '+acno+'</b> is not valid.';                      
                        displayMessage(m, 'error',Title,'warning');
                        $('#txtAccNo').focus(); return false;
                    }
                    ...
                    swal({
                      ...
                      if (result)
                      {
                        ...
                        //Initiate POST
                        var uri = "<?php echo site_url('ui/Userprofileiv/UpdateProfile'); ?>";
