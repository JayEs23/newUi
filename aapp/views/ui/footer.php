<div class="footer-main">
                ...
                <div class="row row-custom">
                    <div class="col-lg-3 col-md-12 col-log-otr">
                        <div class="col-logo-inr">
                            <a href="#" class="logo-otr">
                                <img class="logo-img" src="<?php echo base_url(); ?>/newassets/img/naija_art_mart1.png" alt="brand-logo">
                            </a>
                            <ul class="icon-ul">
                                <li class="icon-li">
                                    <a href="" class="icon-a">
                    ...
                    <div class="col-lg-2 col-md-6 col-nav-otr">
                        <div class="col-nav-inr">
                            ...
                            <ul class="nav-ul">
                                <li class="nav-li">
                                    <a href="#" class="nav-a body-sb">Home</a>
                                </li>
                                <li class="nav-li">
                                    <a href="#" class="nav-a body-sb">Explore</a>
                                </li>
                                <li class="nav-li">
                                    <a href="#" class="nav-a body-sb">Activity</a>
                                </li>
                                <li class="nav-li">
                    ...
                    <div class="col-lg-2 col-md-6 col-explore-otr">
                        <div class="col-explore-inr">
                            ...
                            <ul class="explore-ul">
                                <li class="explore-li">
                                    <a href="#" class="explore-a body-sb">Explore Artworks</a>
                                </li>
                                <li class="explore-li">
                                    <a href="#" class="explore-a body-sb">Single Artwork</a>
                                </li>
                                <li class="explore-li">
                                    <a href="#" class="explore-a body-sb">Explore Creators</a>
                                </li>
                                <li class="explore-li">
                                    <a href="#" class="explore-a body-sb">Single Creator</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-community-inr">
                            ...
                            <ul class="community-ul">
                                <li class="community-li">
                                    <a href="#" class="community-a body-sb">Blog</a>
                                </li>
                                <li class="community-li">
                                    <a href="#" class="community-a body-sb">Help Center</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <img class="circle-1" src="<?php echo base_url(); ?>/newassets/img/svg/footer-circles1.svg" alt="footer-circle">
            <img class="circle-2" src="<?php echo base_url(); ?>/newassets/img/svg/footer-circles2.svg" alt="footer-circle">
        </div>
