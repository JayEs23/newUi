		...
		$(document).ready(function(e) {
			...
			$('#btnPDF').click(function(e) 
			{
				try
				{
					...
					var mydata={email:em,symbol:sym,ReportTitle:msg};	
																
					$.ajax({
						url: "<?php echo site_url('ui/Portfoliorep_in/CreatePDFReport'); ?>",
						data: mydata,
						type: 'POST',
						dataType: 'text',
			...
			function DisplayReport(em,sym)
			{
				try
				{
					...
					var mydata={email:em,symbol:sym};	
					
					$('#recorddisplay > tbody').html('');
					
					$.ajax({
						url: "<?php echo site_url('ui/Portfoliorep_in/DisplayReport');?>",
						data: mydata,
						type: 'POST',
						dataType: 'json',
			...
			function LoadSymbols()
			{
				try
				{
					...
					$.ajax({
						url: "<?php echo site_url('ui/Portfoliorep_in/GetSymbols');?>",
						type: 'POST',
						dataType: 'json',
						success: function(data,status,xhr) {	
							$.unblockUI();
