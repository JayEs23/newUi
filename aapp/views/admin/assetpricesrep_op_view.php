...
<head>
    ...
    <title>Naija Art Mart - Asset Prices Report</title>
	...
	$(document).ready(function(e) {
		...
		$('#btnPDF').click(function(e) 
		{
			try
			{
				...
				$.blockUI({message:'<img src="<?php echo base_url();?>images/loader.gif" /><p>Generating Asset Prices PDF Report. Please Wait...</p>',theme: false,baseZ: 2000});
				...
				if (sdt==edt)
				{
					reportfile="assetpricesrep_op_report_"+sd+".pdf";
				}else
				{
					reportfile="assetpricesrep_op_report_from_"+sd+'_to_'+ed+".pdf";
				}
				
				var msg;
									
				msg='Asset Prices Report';					
				...
				var mydata={symbol:sym,startdate:sdt,enddate:edt,ReportTitle:msg};
															
				$.ajax({
					url: "<?php echo site_url('admin/Assetpricesrep_op/CreatePDFReport'); ?>",
					data: mydata,
					type: 'POST',
					dataType: 'text',
		...
		$('#btnExcel').click(function(e) 
		{
			try
			{
				...
				$.blockUI({message:'<img src="<?php echo base_url();?>images/loader.gif" /><p>Generating Asset Prices Excel Report. Please Wait...</p>',theme: false,baseZ: 2000});
				...
				if (sdt==edt)
				{
					reportfile="assetpricesrep_op_report_"+sd+".xls";
				}else
				{
					reportfile="assetpricesrep_op_report_from_"+sd+'_to_'+ed+".xls";
				}
				...
				$.ajax({
					url: "<?php echo site_url('admin/Assetpricesrep_op/CreateExcelReport'); ?>",
					data: mydata,
					type: 'POST',
					dataType: 'text',
					complete: function(xhr, textStatus) {					
		...
		function DisplayReport(sym,sdt,edt)
		{
			try
			{
				$.blockUI({message:'<img src="<?php echo base_url();?>images/loader.gif" /><p>Retrieving Asset Prices Report Records. Please Wait...</p>',theme: false,baseZ: 2000});
				...
				var mydata={symbol:sym,startdate:sdt,enddate:edt};	
				
				$('#recorddisplay > tbody').html('');
				
				$.ajax({
					url: "<?php echo site_url('admin/Assetpricesrep_op/DisplayReport');?>",
					data: mydata,
					type: 'POST',
					dataType: 'json',
					success: function(dataSet,status,xhr) {	
						...
						table = $('#recorddisplay').DataTable( {
							...
							ordering: false,
							autoWidth:false,
							language: {zeroRecords: "No Asset Price Record Found"},
							...
							columns: [
								...
								{ width: "11%" },//High Price
								{ width: "11%" },//Low Price
								{ width: "17%" },//Previous Close Price
								{ width: "10%" },//Trades
								{ width: "15%" },//Trades Value
	...
	function LoadSymbols()
	{
		try
		{
			...
			$.ajax({
				url: "<?php echo site_url('admin/Assetpricesrep_op/GetSymbols');?>",
				type: 'POST',
				dataType: 'json',
				success: function(data,status,xhr) {	
					$.unblockUI();
                    ...
                    <ul class="body-tabs-layout tabs-animated body-tabs-animated nav">
                        ...
                        <li class="nav-item">
                            <a role="tab" class="nav-link" id="tabView" data-toggle="tab" href="#view">
                                <span>View Asset Prices Report</span>
                            </a>
                        </li>
                                        ...
                                        <div class="card-body">
                                           <table class="hover table table-bordered data-table display wrap " id="recorddisplay">
                                              <thead style="color:#ffffff; background-color:#7E7B7B;">
                                                <tr>
                                                    <th style="text-align:center" width="10%">PRICE&nbsp;DATE</th>
                                                    <th style="text-align:center" width="15%">ASSET</th>
                                                    <th style="text-align:center" width="11%">PRICE(₦)</th>
                                                    <th style="text-align:right; padding-right:7px;" width="11%">HIGH&nbsp;PRICE(₦)</th>
                                                    <th style="text-align:right; padding-right:7px;" width="11%">LOW&nbsp;PRICE(₦)</th>
                                                    <th style="text-align:center" width="17%">PREVIOUS&nbsp;CLOSE&nbsp;PRICE(₦)</th>
                                                    
                                                    <th style="text-align:center" width="10%">TRADES</th>
                                                    <th style="text-align:center" width="15%">TRADES&nbsp;VALUE</th>
                                                </tr>
                                              </thead>
                                            </table>                                           
                                        </div>
