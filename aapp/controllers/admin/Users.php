...
class Users extends CI_Controller {
	...
	function AddUsers()
	{
		...
		if ($this->input->post('ManageUsers')) $ManageUsers = trim($this->input->post('ManageUsers'));		
		...
		}else
		{
			...
			$dat=array(
				...
				'ManageUsers' 		    => $this->db->escape_str($ManageUsers),	
	...
	function EditUsers()
	{
		...
		$AddItem='0';$EditItem='0'; $DeleteItem='0'; $CreateAccount='0';$ManageUsers='0'; $ClearLogFiles='0'; $SetParameters='0'; 		$ViewLogReports='0'; $ViewReports='0';
		...
		}else
		{
			...
			$ait='0'; $eit='0'; $dit='0'; $cusr='0'; $mgmr='0'; $clog='0'; $vlog='0'; $vrep='0'; $spar='0';
			...
			if ($row->ManageUsers==1) $mgmr=$row->ManageUsers;					
	...
	public function index()
	{
		...
		if ($_SESSION['email'])
		{
			...
			if ($perm->ManageUsers==1) $data['ManageUsers']=1;
