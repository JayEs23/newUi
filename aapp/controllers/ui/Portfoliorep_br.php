...
class Portfoliorep_br extends CI_Controller {
	...
	function DisplayReport()
	{
		...
		$qry = "SELECT * FROM portfolios WHERE (TRIM(broker_id)='".$this->db->escape_str($broker_id)."')";
	...
	{
		$period=''; $ReportTitle=''; $broker_id=''; $symbol='';
...
<tr align="center">										
	...
	public function index()
	{
		...
		if (isset($_SESSION['email']))
		{
			...
			$this->load->view('ui/portfoliorep_br_view',$data);
		}else
		{
