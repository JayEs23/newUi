...
class Depositsrep_in extends CI_Controller {
	...
	function CreatePDFReport()
	{
		...
		if ($startdate==$enddate)
		{
			...
			{
				$outputfile="reports\deposit_in_report_".str_replace(' ','-',$dstart).".pdf";
			}elseif (strtolower(trim($_SERVER['HTTP_HOST']))=='www.naijaartmart.com')
			{
				$outputfile="reports/deposit_in_report_".str_replace(' ','-',$dstart).".pdf";
			}
			
			$filename="deposit_in_report_".str_replace(' ','-',$dstart).".pdf";
		}else
		{
			if (strtolower(trim($_SERVER['HTTP_HOST']))=='localhost')
			{
				$outputfile="reports\deposit_in_report_from_".str_replace(' ','-',$dstart).'_to_'.str_replace(' ','-',$dend).".pdf";
			}elseif (strtolower(trim($_SERVER['HTTP_HOST']))=='www.naijaartmart.com')
			{
				$outputfile="reports/deposit_in_report_from_".str_replace(' ','-',$dstart).'_to_'.str_replace(' ','-',$dend).".pdf";
			}
			
			$filename="deposit_in_report_from_".str_replace(' ','-',$dstart).'_to_'.str_replace(' ','-',$dend).".pdf";
		}
...
<thead>
   <tr bgcolor="#EEEEEE">
	...
	<td align="right" valign="middle" width="10%"><b><font size="10pt" face="Arial">TRANS. FEE (NGN)</font></b></td>
	<td align="center" valign="middle" width="10%"><b><font size="10pt" face="Arial">TRANS. REF.</font></b></td>
	<td align="center" valign="middle" width="20%"><b><font size="10pt" face="Arial">DESCRIPTION</font></b></td>
...
<tr align="center">										
	...
	<td valign="middle" align="right" width="10%"><font size="9pt" face="Georgia, Times New Roman, Times, serif">'.$fee.'</font></td>
	<td valign="middle" align="center" width="10%"><font size="9pt" face="Georgia, Times New Roman, Times, serif">'.$ref.'</font></td>
	<td valign="middle" align="center" width="20%"><font size="9pt" face="Georgia, Times New Roman, Times, serif">'.$desc.'</font></td>
	...
	public function index()
	{
		...
		if (isset($_SESSION['email']))
		{
			...
			$this->load->view('ui/depositsrep_in_view',$data);
		}else
		{
